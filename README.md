...
**5. Discussion**
   - Keras doesn't provide pre-trained model for AlexNet, so it was used without loading weights. If pre-trained weights is available, its accuracy could improve.  
